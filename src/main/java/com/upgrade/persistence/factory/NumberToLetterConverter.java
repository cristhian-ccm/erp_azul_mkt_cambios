...
public class NumberToLetterConverter {
    ...
    /**
     * Convierte a letras un numero de la forma S/123,456.32
     ...
     */
    public static String convertNumberToLetter(double doubleNumber,String moneda)throws NumberFormatException {   
        System.out.println("convertNumberToLetter ......: Iniciando Coversion "+doubleNumber);
...
//        doubleNumber = Double.parseDouble(formatedDouble);
       ...
       if(valor.length()==1){
            converted.append(" CON ").append(splitNumber[1]).append("0").append("/100 ");
        } else {
            converted.append(" CON ").append(splitNumber[1]).append("/100 ");
        }
        if ("PEN".equals(moneda)) {
            converted.append("SOLES");
        } else if ("USD".equals(moneda)) {
            converted.append("DOLARES AMERICANOS");
        }
        System.out.println("convertNumberToLetter ......:" + doubleNumber);
        System.out.println("convertNumberToLetter ......:" + converted.toString());
