 ...
 */
/*@Route
@PWA(name = "Vaadin up.erp.Application",
...
public class MainView extends VerticalLayout {
    ...
    public final Button btnPlantillaTrans = new Button("Plantilla de transformacion", VaadinIcon.AUTOMATION.create());
    public final Button btnCPanel = new Button("CPanel Ecommerce", VaadinIcon.CLOUD.create());


    public MainView() {
//        initConection();
        add(btnPlantillaTrans,btnCPanel);
        initEvents();
        initStyles();
    }
