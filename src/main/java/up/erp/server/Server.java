...
public class Server {
   ...
   /*
    public static String PATH_WEBAPPS = "C:/Gustavo/";
    //public static String PATH_WEBAPPS = "C:/Users/Luis Aleman/Documents/2020/Upgrade 2020/ecommerce/erp/up_erp3_vsb/src/main/resources/META-INF/resources/";
    public static String PATH_IMAGES = PATH_WEBAPPS + "ecommerce/images/";
    public static String PATH_PDF = PATH_WEBAPPS + "ecommerce/pdf/";
    public static String PATH_DEFIMG = PATH_WEBAPPS + "ecommerce/images/default.jpg";
    public static String PATH_PROMO = PATH_WEBAPPS + "ecommerce/promos/";
    public static String PATH_REPORTS = PATH_WEBAPPS + "ecommerce/reportes/";
   ...
   */
   ...
   /*
    //LOCAL
    public static String URL_SERVER = "C:/Gustavo/";
