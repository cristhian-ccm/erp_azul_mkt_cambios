 ...
 * @author Luis Aleman
 */
public class IndexWeb2View extends IndexWeb2UI{
    //--------------------------------------------------------------------------
    //CPANEL RUTH
    //--------------------------------------------------------------------------
    public App app;
    
    public IndexWeb2View(App app) {
        this.app = app;
    }
    ...
    public void init_Sliders(){
        ...
        if(!l_slidersE.isEmpty()){
            ...
            //Url Imagen
            if(sliderE.getUrl_imagen() == null || sliderE.getUrl_imagen() == "") {imgSE.setSrc("");} 
            //if(sliderE.getUrl_imagen() != null || sliderE.getUrl_imagen() != "") {imgSE.setSrc(sliderE.getUrl_imagen());}
            else {imgSE.setSrc(sliderE.getUrl_imagen());}
            
            //Url Imagen - TextField
            if(sliderE.getUrl_imagen() == null || sliderE.getUrl_imagen() == "") {txtSEUpload.setValue("");} 
            //if(sliderE.getUrl_imagen() != null || sliderE.getUrl_imagen() != "") {txtSEUpload.setValue(sliderE.getUrl_imagen());}
            else  {txtSEUpload.setValue(sliderE.getUrl_imagen());}
            
            //Url Link
            if(sliderE.getUrl_link() == null || sliderE.getUrl_link() == "") {txtSELink.setValue("");} 
            //if(sliderE.getUrl_link() != null || sliderE.getUrl_link() != "") {txtSELink.setValue(sliderE.getUrl_link());}
            else {txtSELink.setValue(sliderE.getUrl_link());}
            
            //Activo
            if(sliderE.getActivo() == null) {checkSE_Activate.setValue(Boolean.FALSE);} 
            //if(sliderE.getActivo() != null) {checkSE_Activate.setValue(sliderE.getActivo());}
            else {checkSE_Activate.setValue(sliderE.getActivo());}
        }
        else {
            imgSE.setSrc("");
    ...
    public void on_Anterior_SliderExist(){
        ...
        if(iterator_slidersE >= 0 && iterator_slidersE < list_size){    
            ...
            //------------------------------------------------------------------
            if(sliderE.getUrl_imagen() == null) {url_img_Slider = "";}
            else {url_img_Slider = sliderE.getUrl_imagen();}
            //------------------------------------------------------------------
            if(sliderE.getUrl_link() == null) {url_link_Slider = "";}
            else {url_link_Slider = sliderE.getUrl_link();}
            //------------------------------------------------------------------
    ...
    */
    ...
    public void On_Click_GuardarCambios(){
        ...
        //-----------------------------------------------------------------------------------------------
        if(!txtdialog_TLEcom.isEmpty()){titulo_Banner = txtdialog_TLEcom.getValue();}

        if(!txtdialog_SubtLEcom.isEmpty()){subtitulo_Banner = txtdialog_SubtLEcom.getValue();}
