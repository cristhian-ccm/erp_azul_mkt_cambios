...
public abstract class ProductosUI extends VerticalLayout {
    ...
    // public final Button btnProductos = new Button("Gestión Productos",
    ...
    // -----------------------------------------------------------------------------------------------
    public final HorizontalLayout layCPanelButtons2 = new HorizontalLayout(btnPedidos, btnLineas, btnEcomPage,
            btnSalirCP);
    // -----------------------------------------------------------------------------------------------
    // END CABECERA
    // -----------------------------------------------------------------------------------------------
    ...
    // 3) Botones
    // public final Button btnBuscarCodigo = new Button("Buscar Por
    // Codigo",VaadinIcon.SEARCH.create());
    ...
    public final VerticalLayout lay_Busquedas = new VerticalLayout(lay_titulo_bus, primaryBar, primaryBar2,
            primaryBar3);
    // --------------------------------------------------------------------------------------------
    // TABLE - INFORMATION
    ...
    public final Icon caracteristica = VaadinIcon.COGS.create();
    public final Icon limite_comp = VaadinIcon.STORAGE.create();

    public final Button btnCaracteristica = new Button("Agregar Caracteristicas", caracteristica);
    ...
    // --------------------------------------------------------------------------------------------
    // public final HorizontalLayout fButtons = new
    // HorizontalLayout(btnpromo,btnlimite_compra,btnsave,btndelete,btnExit);
    public final HorizontalLayout fButtons = new HorizontalLayout(btnCaracteristica, btnlimite_compra, btnsave,
            btndelete, btnExit);
    // --------------------------------------------------------------------------------------------
    // END MAIN - VIEW
    // --------------------------------------------------------------------------------------------
    ...
    /*
     * public final Label lbUpload1 = new Label("Imagen a cargar: "); public final
     * TextField txtUpload1 = new TextField(""); public final Button btnUpload1 =
     * new Button("Actualizar"); public final HorizontalLayout laydialogUp1 = new
     * HorizontalLayout(upload1);
     * 
     * public final Label lbUpload2 = new Label("Imagen a cargar: "); public final
     * TextField txtUpload2 = new TextField(""); public final Button btnUpload2 =
     * new Button("Actualizar"); public final HorizontalLayout laydialogUp2 = new
     * HorizontalLayout(upload2);
     * 
     * public final Label lbUpload3 = new Label("Imagen a cargar: "); public final
     * TextField txtUpload3 = new TextField(""); public final Button btnUpload3 =
     * new Button("Actualizar"); public final HorizontalLayout laydialogUp3 = new
     * HorizontalLayout(upload3); public final HorizontalLayout laydialogUP = new
     * HorizontalLayout(laydialogUp1,laydialogUp2,laydialogUp3);
     */
    // --------------------------------------------------------------------------------------------
    // BODY
    ...
    // public final HorizontalLayout dialogform3 = new
    // HorizontalLayout(lbPrecioEcom,txtPrecioEcom);
    ...
    // public final HorizontalLayout dialogform4 = new
    // HorizontalLayout(txtNameEcom,cmbLineaEcom,txtLineaEcom,txtPrecioEcom,txtLimiteEcom);
    public final HorizontalLayout dialogform4 = new HorizontalLayout(txtNameEcom, txtPrecioEcom, txtLimiteEcom,
            txtStockAct);
    ...
    public final VerticalLayout dialogmainform = new VerticalLayout(layTitulo_dialog, dialogform1_final, layInfo_dialog,
            dialogform4, dialogform5, layImages, dialogform6);

    public final Dialog dialogEcomm = new Dialog(dialogmainform);

    // ----------------------------------------------------------------------------------------
    // DIALOG PRODUCTO CARACTERISTICA

    public final Label titulo_dialogCar = new Label("CARACTERISTICAS - PRODUCTO");
    public final HorizontalLayout layTitulo_dialogCar = new HorizontalLayout(titulo_dialogCar);

    public final VerticalLayout dialogmainformCar = new VerticalLayout(layTitulo_dialogCar);
    public final Dialog dialogCaracteristica = new Dialog(dialogmainformCar);
    ...
    public final Label notf_select_exceed = new Label(
            "Más de un Producto ha sido seleccionado. Por favor, seleccione sólo uno");
    ...
    public final VerticalLayout laydialogLimiteC = new VerticalLayout(layTitulo_dialog_lcompra, dialogLimiteC1,
            dialogLimiteC2);
    ...
    // --------------------------------------------------------------------------------------------
    // public final Label lbDescriptionPanel = new Label("En esta pantalla se puede
    // Agregar productos a Ecommerce o quitarlos");
    // public final HorizontalLayout layDescriptionPanel = new
    // HorizontalLayout(lbDescriptionPanel);
    // --------------------------------------------------------------------------------------------
    // END DIALOG - PANEL EDICION E-COMMERCE
    // --------------------------------------------------------------------------------------------
    ...
    private void initStyles() {
        ...
        /*
         * btnCaracteristica.setWidthFull();
         * btnCaracteristica.getStyle().set("fontSize", "80%");
         */
        ...
        grid.addColumn(Producto::getEcommerce_descrip).setAutoWidth(true).setSortable(true)
                .setHeader("Descripcion Ecommerce");
         ...
         * on_Open_Ecomdialog(); dialogEcomm.open(); })).addAttachListener(e->{
         * multiSelect.addValueChangeListener(event -> { if
         * (event.getValue().isEmpty()){ e.getSource().setVisible(false); } else
         * e.getSource().setVisible(true); }); });
         */
        /*
         * //Producto P = new Producto(); MultiSelect<Grid<Producto>, Producto>
         * multiSelect = grid.asMultiSelect(); multiSelect.addValueChangeListener(event
         * -> { if (event.getValue().isEmpty()){ grid.addColumn(new
         * NativeButtonRenderer<>("Editar Ecom",item -> { grid.setDetailsVisible(item,
         * !grid.isDetailsVisible(item)); on_Open_Ecomdialog(); dialogEcomm.open(); }));
         * } });
         */
        // -------------------------------------------------------------------------------
        ...
        dialogmainformCar.setJustifyContentMode(FlexComponent.JustifyContentMode.START);
        dialogmainformCar.setAlignItems(FlexComponent.Alignment.CENTER);
        dialogmainformCar.setWidthFull();
        ...
        txtPrecioEcom.addValueChangeListener(event -> {
            Comprobar_Utilidad();
        });
    ...
    // Dialog caracteristicas productos
    public abstract void onOpenCaracteristicaDialog();
    ...
    private void initEvents() {
        ...
        btnCaracteristica.addClickListener(e -> {
            onOpenCaracteristicaDialog();
