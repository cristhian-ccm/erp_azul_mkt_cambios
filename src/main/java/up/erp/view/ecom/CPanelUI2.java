...
public abstract class CPanelUI2 extends VerticalLayout {
    ...
    //-----------------------------------------------------------------------------------------------
    public final VerticalLayout lay_DashBoard1 = new VerticalLayout(laydash1_Titulo,lay_Dash1,laydash1_TitFecha,lay_DateDash1);
    //-----------------------------------------------------------------------------------------------
    //DASHBOARD 1: END
    //-----------------------------------------------------------------------------------------------
    //-----------------------------------------------------------------------------------------------
    ...
    //-----------------------------------------------------------------------------------------------
    public final VerticalLayout lay_DashBoard2 = new VerticalLayout(laydash2_Titulo,lay_Dash2,laydash2_TitFecha,lay_DateDash2);
    //-----------------------------------------------------------------------------------------------
    //DASHBOARD 2: END
    //-----------------------------------------------------------------------------------------------
    //-----------------------------------------------------------------------------------------------
    ...
    //-----------------------------------------------------------------------------------------------
    public final VerticalLayout lay_DashBoard3 = new VerticalLayout(laydash3_Titulo,laydash3_TitFecha,lay_DateDash3,laydash3_EVentasT,lay_Dash3);
    //-----------------------------------------------------------------------------------------------
    //DASHBOARD 3: END
    //-----------------------------------------------------------------------------------------------
    
    //-----------------------------------------------------------------------------------------------
    //DASHBOARD 4: TITULO : ECOMMERCE: CANTIDAD COMPRAS INCONCLUSAS - (ITEMS EN CARRITO)
    //-----------------------------------------------------------------------------------------------
    ...
    public final HorizontalLayout laydash4_CartNoShopT = new HorizontalLayout(dash4_CartNoShopTit,dash4_CartNoShopTitCant);
    //-----------------------------------------------------------------------------------------------
    ...
    public final VerticalLayout layPanelButtons = new VerticalLayout( btnClientes,btnSubscriptores,btnPedidos,btnLineas,btnProductos,btnEcomPage,
                                                                      btnCupones,btnPromociones,btnPuntosUP,btnCrudBan, btnSalirCP);
    //-----------------------------------------------------------------------------------------------
    ...
    public CPanelUI2() {
        ...
        add(head,lay_Dashboards,lay_Dashboards2,lay_Dashboards3,lay_GoogleAnalytics,layModulos_Titulo,layPanelButtons);
        initStyles();
        initEvents();
    }
