 ...
 */
public abstract class ReciboUI extends VerticalLayout{
    ...
    public ReciboUI(){    
        ...
        gridNotasPedido.addColumn(Recibo::getMonto).setHeader("Monto").setSortable(true);
        ...
        btnCerrarDialogCobranza.addClickListener(e->{
            dlogEliminarCobranzaAntigua.close();
        });
    ...
    public final void initDialogs()
    {
        ...
        columnAnularLayout.add(new Hr(),2);
        columnAnularLayout.add(btnAnularCobranzaDia,1);
        columnAnularLayout.add(btnCerrarDialogCobranzaDia,1); 
        ...
        columnEliminarLayout.add(new Hr(),2);
        columnEliminarLayout.add(btnAnularCobranza, 1);
        columnEliminarLayout.add(btnCerrarDialogCobranza, 1); 
